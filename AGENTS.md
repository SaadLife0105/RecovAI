...
- Codex Haiku (pinned version string, never a floating alias) for the RAG chatbot, XAI explanations, and the autonomous agent — called only from Supabase Edge Functions, never from the client
